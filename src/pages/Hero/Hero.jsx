...
const profile = {
    name: 'Aelisha Patel',
    title: 'Full-Stack Developer | React.js | Next.js',
    skills: [
        'React', 'NextJS', 'Redux', 'Express', 'MongoDB', 
        'TypeScript', 'Javascript', 'Git', 'html', 'css',
        'Tailwind css', 'node js', 'Bitbucket', 'Angular'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  JavaScript Enthusiast 🚀 | Building frameworks & <br /> shaping the future 💻✨ | Web Creator 🔧
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  target="_blank"
                  href="https://github.com/aelishap"
